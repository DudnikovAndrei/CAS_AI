...
def train(epoch):
    ...
    for k in range(N):
        x = epoch[np.random.randint(0, count)]      # случайный ввыбор входного сигнала из обучающей выборки
        y, out = go_forward(x[0:3])                 # прямой проход по HC и вычисление выходных значений нейронов
        e = y - x[-1]                               # ошибка
